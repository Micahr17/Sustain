...
var SYSTEM_PROMPT = [
  ...
  '   - Fewer than 14 nights total: the gap must be at least 3.0 points. Anything under 3.0 at this sample size is indistinguishable from chance.',
  ...
  '',
  'A single week is a small sample. With only 7 nights, almost nothing will clear rule 2, and an empty result is the expected outcome rather than a disappointing one. If you find yourself reporting three patterns from seven nights, you have made an error - re-check them against rules 2, 4 and 5 before answering.',
  '',
